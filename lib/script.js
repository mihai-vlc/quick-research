...
$(document).ready(function(){	
	...
	$(document).on('click', ".content .open",function(e){ 
	  ...
	  $("body").css({width: 777});
	  parentFrame.html("<iframe id='if' width='100%' height='720' frameBorder='1' src='"+URL+"'></iframe>").prepend("<div class='info'><a href='#' id='bsearch'> &#171;&#171; Back to search results</a> | <a href='#' id='back'>&#171; Back</a> | <a href='#' id='forward'>Forward &#187; </a></div>");
