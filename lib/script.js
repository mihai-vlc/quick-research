...
$(document).ready(function(){	
			...
			jQTubeUtil.search(q,function(response){ 
				...
				for(var vid in response.videos){
					...
					html += "<div class='result'>"+
					     ...
					     "<div><img src='"+ video.thumbs[0].url +"' alt='"+video.title+"' class='ytube' data-id='"+ video.videoId +"'></div>"+
					   "</div>";
				}
				$("#tabs-3").html(html);
			});
	...
	$(document).on("click", ".ytube", function() {
		...
		$(this).parent().html("<iframe width=\"640\" height=\"360\" src=\"https://www.youtube.com/embed/"+videoId+"?feature=player_detailpage&autoplay=1\" frameborder=\"0\" allowfullscreen></iframe>");
	});
